...
Composed component template without framework dependencies (Transformer variant)
"""
...
class ComposedComponent(HarnessComponent):
    ...
    def __init__(self, name: str, config: Dict[str, Any] = None):
        ...
        self.component_type = config.get('component_type', 'transformer') if config else 'transformer'
