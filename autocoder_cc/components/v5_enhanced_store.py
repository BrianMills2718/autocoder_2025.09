...
class V5EnhancedStore(Store):
    ...
    async def setup(self):
        ...
        if self.testing_mode:
            self.logger.info(f"🧪 Setting up V5.0 enhanced database integration for {self.name} (TESTING MODE)")
    ...
    async def _setup_testing_mode(self):
        ...
        self.logger.info(f"✅ V5.0 database integration setup complete for {self.name} (TESTING MODE)")
